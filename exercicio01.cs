    ...
    public class exercicio01
    {
        ...
        public static void planosMassa(int salario, String plano) {
            ...
            switch(plano) {
                ...
                case "A":
                float aumentoA = salario * 0.1f;
                float novoSalarioA = salario + aumentoA;
                Console.WriteLine("O novo salário ficou: " + novoSalarioA);
                break;
                case "B":
                float aumentoB = salario * 0.15f;
                float novoSalarioB = salario + aumentoB;
                Console.WriteLine("O novo salário ficou: " + novoSalarioB);
                break;
                case "C":
                float aumentoC = salario * 0.20f;
                float novoSalarioC = salario + aumentoC;
